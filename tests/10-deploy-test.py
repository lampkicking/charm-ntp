...
ubuntu_0_public_address = ubuntu_unit_0.info['public-address']
print('ubuntu/0 public address ' + ubuntu_0_public_address)
ubuntu_1_public_address = ubuntu_unit_1.info['public-address']
print('ubuntu/1 public address ' + ubuntu_1_public_address)
...
configuration_file.index(ubuntu_1_public_address)
